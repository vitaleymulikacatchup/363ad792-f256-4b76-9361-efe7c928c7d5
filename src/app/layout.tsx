...
export const metadata: Metadata = {
  title: "TechFlow Solutions - Custom Software Development Company",
  description: "Transform your business with custom software solutions. Web development, mobile apps, cloud solutions, and technology consulting from expert developers.",
  keywords: "software development, web development, mobile apps, cloud solutions, custom software, technology consulting, IT services",
  metadataBase: new URL("https://techflowsolutions.com"),
  alternates: {
    canonical: "https://techflowsolutions.com"
  },
  openGraph: {
    title: "TechFlow Solutions - Custom Software Development Company",
    description: "Transform your business with custom software solutions. Expert development team delivering web apps, mobile solutions, and cloud infrastructure.",
    siteName: "TechFlow Solutions",
    type: "website",
    images: [
      {
        url: "https://images.pexels.com/photos/7688173/pexels-photo-7688173.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        alt: "TechFlow Solutions - Professional development team"
      }
    ]
  },
  twitter: {
    ...
    description: "Expert software development services for modern businesses. Web apps, mobile solutions, and cloud infrastructure.",
    images: ["https://images.pexels.com/photos/7688173/pexels-photo-7688173.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
